...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/SS_Youtube 1.png');?>'); background-size:100%;">
<div class="login-box">
	<br/>
  <div class="login-logo">
    <a href="index.php" style="color: yellow;"><img src="https://ukmpenelitianuny.org/wp-content/themes/web-ukmp/images/logo/Group 7.png" alt=""></a>
  </div>
...
<footer>
    <div class="login-box-body text-center">
       <a style="color: dark-blue;"> Copyright &copy; Sistem Perpustakaan UKMP - <?php echo date("Y");?>
    </div>
  </footer>
<!-- /.login-box -->
<!-- Response Ajax -->
