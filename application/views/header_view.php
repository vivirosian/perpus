...
<head>
  ...
  <title><?php echo $title_web;?> Perpustakaan UKMP </title>
...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url('index.php/dashboard');?>" class="logo">
      ...
      <span class="logo-mini">UKMP</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="https://ukmpenelitianuny.org/wp-content/themes/web-ukmp/images/logo/Group 7.png" alt="" width="150" ></span>
    </a>
